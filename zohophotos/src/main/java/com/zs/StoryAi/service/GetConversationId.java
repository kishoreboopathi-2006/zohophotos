...
public class GetConversationId {
	...
	public static String createChat(String assistantId, String fileId) throws Exception {
		...
		textObj.put("text", "\"Capture the feeling and facial expression and short.\"\n");
		...
		Request request = new Request.Builder()
				.url("https://platformai.csez.zohocorpin.com/internalapi/v2/ai/assistant/chat").post(body)
				.addHeader("portal_id", "ZS").addHeader("zuid", "60042586463")
				.addHeader("Authorization", "Zoho-oauthtoken " + CsezAccessToken.generateAccessToken())
		...
		try (Response response = client.newCall(request).execute()) {
			...
			return json.getJSONObject("data").optString("conversation_id", "NO_CONVERSATION_ID");
		}
	}
}
